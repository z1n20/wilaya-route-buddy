...
const universities = [
  ...
  "Université d'Alger 2 Bouzareah",
  "Université d'Alger 3",
  "Université de Blida 1",
  "Université de Blida 2 Lounici Ali",
  "Université de Boumerdès - UMBB",
  ...
  "Université de Batna 1 Hadj Lakhdar",
  ...
  "Université de Saïda - Tahar Moulay",
  "Université de Béchar - Tahri Mohamed",
  "Université d'Adrar",
  ...
  "Université de Mila - Abdelhafid Boussouf",
